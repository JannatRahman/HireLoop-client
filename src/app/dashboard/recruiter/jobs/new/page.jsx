...
import { 
  ...
  ListBox, 
  Select,
  TextField, // Imported to handle validation and error messages seamlessly
  FieldError
} from "@heroui/react";
// Gravity UI Icons
...
export default function PostJobPage() {
  //TODO: Mock Recruiter & Company Data for Validation & Autocomplete
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Saving job successfully:", payload);
